...
One way Wilson et al. suggests to practice computational reproducibility is to save raw data and record all steps used to process data. This can be easily done with a combination of R and Github, since R works with raw data, and Github streamlines version control and interates seamlessly into R. 
